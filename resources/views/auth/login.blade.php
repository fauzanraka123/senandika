...
<body class="bg-[#F8F6F2] text-[#1A1A1A] font-sans h-screen flex flex-col justify-center items-center">
    ...
    <div class="w-full max-w-md p-8 bg-white rounded-2xl shadow-sm border border-stone-200">
        <div class="text-center mb-8">
            <h1 class="text-4xl font-serif text-[#8B5E3C] mb-2 tracking-tight">RuangKata</h1>
        ...
        <div class="mt-8 text-center text-sm text-stone-400">
            Dengan melanjutkan, Anda menyetujui <a href="#" class="underline hover:text-stone-600">Ketentuan Layanan</a> dan <a href="#" class="underline hover:text-stone-600">Kebijakan Privasi</a> RuangKata.
        </div>
    </div>
