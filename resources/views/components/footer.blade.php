<footer class="bg-white dark:bg-[#0F0F0F] border-t border-stone-200 dark:border-stone-800 py-12 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex justify-center md:justify-start md:w-1/3">
                <a href="/" class="text-3xl font-serif text-[#8B5E3C] dark:text-[#C9A27C] tracking-tight">RuangKata</a>
            </div>
            
            <div class="mt-8 md:mt-0 flex justify-center space-x-6 md:w-1/3">
                <a href="#" class="text-stone-400 hover:text-[#8B5E3C] dark:hover:text-[#C9A27C] transition-colors">
